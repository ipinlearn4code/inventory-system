            ...
            <div class="sticker">
                ...
                <div class="info-section">
                    ...
                    <div class="specs"></div>
                        ...
                        @if($sticker['device']->spec3) {{ $sticker['device']->spec3 }}<br>@endif
                        @if($sticker['device']->spec4) {{ $sticker['device']->spec4 }}<br>@endif
                        @if($sticker['device']->spec5) {{ $sticker['device']->spec5 }}@endif
                    </div>
                    @endif
